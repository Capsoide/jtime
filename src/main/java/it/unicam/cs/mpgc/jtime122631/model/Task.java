...
public class Task implements InfoTask {
    ...
    public Task(int projectId, String title) {
        this(0, projectId, title, TaskStatus.PENDING, TaskPriority.NORMALE ,Duration.ZERO, Duration.ZERO, null);
    }

    public Task(int id, int projectId, String title, TaskStatus status, TaskPriority priority,
        ...
        this.priority = priority != null ? priority : TaskPriority.NORMALE;
    ...
    @Override public TaskPriority getPriority() { return priority; }
